...
export const texts = {
  "PT-BR": {
    ...
    tech_uiux: "UI/UX",
    tech_java_tag: "Java",
    tech_spring_tag: "Spring Boot",
    tech_postgres_tag: "PostgreSQL",
    tech_javascript_tag: "JavaScript",
    tech_react_tag: "React",
    tech_tailwind_tag: "Tailwind",
    tech_vite_tag: "Vite",
